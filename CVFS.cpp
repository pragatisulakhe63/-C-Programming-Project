...
void man(char *name)
{
    ...
    {
        printf("Description : Used to read data from regualr file\n");
        printf("Usage : read File_name No_Of_Bytes_To_Read\n");
    }
    else if(strcmp(name,"Write") == 0)
    {
        printf("Description : Used to write into regualr file\n");
        ...
        count = sscanf(str,"%s %s %s %s",command[0],command[1],command[2],command[3]);
            ...
            if(count == 2)
            {
                ...
                else if(strcmp(command[0],"write") == 0)
                {
                    ...
                    if(iret == 0)
                    {
                        printf("ERROR : Incorrect parametern\n");
                        continue;
                    }       
